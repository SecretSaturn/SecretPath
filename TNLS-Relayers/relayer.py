...
class Relayer:
    def __init__(self,
        ...
        eth_contract_interface = EthContract(interface=eth_base_interface,address="0xA24d9E7aD7F98B935f0762C14b8e8c7F4ED7CbbD",abi=eth_abi)
        ...
        scrt_contract_interface = SCRTContract(interface=scrt_base_interface, address="secret1s8gskjex5ffwr9ke9hzhxqr7rncxcv660wl6m2",abi=scrt_abi)
